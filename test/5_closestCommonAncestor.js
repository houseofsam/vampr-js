...
describe("Vampire", function() {
  ...
  describe("closestCommonAncestor", function() {
    ...
    it("should be offspring 3 for offspring 4 and 7", () => {
      expect(offspring4.closestCommonAncestor(offspring7)).to.equal(offspring3.name);
      expect(offspring7.closestCommonAncestor(offspring4)).to.equal(offspring3.name);
    })
    ...
    it("should be the more senior vampire if a direct ancestor is used", () => {
      expect(offspring6.closestCommonAncestor(offspring7)).to.equal(offspring6.name);
      expect(offspring7.closestCommonAncestor(offspring6)).to.equal(offspring6.name);
    })
